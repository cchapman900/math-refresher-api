...
This is a sample template for Math Refresher API - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name math-refresher-api --tail
```
...
```bash
aws cloudformation delete-stack --stack-name math-refresher-api
```
